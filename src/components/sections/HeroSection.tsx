...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div className="relative z-10 container mx-auto px-4 text-center pointer-events-auto" initial={{
      opacity: 0,
      scale: 0.95,
      filter: "blur(10px)"
    }} animate={{
      ...
      ease: [0.25, 0.46, 0.45, 0.94]
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          {/* Date Badge */}
          <motion.div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card border-primary/30" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          delay: 0.4
            ...
            <ParticleTextEffect words={particleWords} intervalMs={4000} className="min-h-[80px] md:min-h-[120px]" />
          </motion.div>

          {/* Subheading */}
          <motion.p className="text-xl lg:text-3xl text-foreground/90 font-serif font-bold md:text-5xl" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          {/* Description */}
          <motion.p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto font-extrabold py-0" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          {/* Tagline */}
          <motion.p className="text-sm md:text-base text-primary font-medium tracking-widest uppercase" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          {/* CTA Buttons */}
          <motion.div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
